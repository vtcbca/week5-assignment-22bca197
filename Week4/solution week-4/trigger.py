...
cur.execute("""insert into contact values
                (1,'om','rathod',9876546785,'om@gmail.com','surat'),
                (2,'sai','modi',9087908723,'sai@gmail.com','bajipura'),
                (3,'ram','shah',1234543216,'ram,@gmail.com','tapi'),
                (4,'krishna','prajapati',9876876543,'krishna@gmail.com','vyara'),
                (5,'preeti','patel',8877554465,'preeti@gmail.com','vapi');""")
